...
export default function ContactForm() {
  ...
  const apiKey = process.env.PUBLIC_ACCESS_KEY || "b8db9a15-5daa-4aad-b16f-9cbe726b1df5";

  const { submit: onSubmit } = useWeb3Forms({
    access_key: apiKey,
    settings: {
      from_name: "Raffa Parabola",
  ...
  <div className="bg-gray-50 dark:bg-neutral-900" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          Choose an option below and well be happy to show you.
        </p>
      </div>

   <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          <h2 className="text-lg font-bold">Contact Raffa Parabola</h2>
          <p className="max-w-sm mt-4 mb-4 dark:text-neutral-400">
          Silakan isi kontak @email  atau chat whatsapp untuk menghubungi admin . Jika tidak ada halangan, admin akan langsung merespon pesan yang Anda kirimkan. Terima kasih.
          </p>
          ...
          <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-neutral-400">
            ...
            <a href="mailto:hello@halley.vercel.app">sbgyogi@gmail.com</a>
          </div>
